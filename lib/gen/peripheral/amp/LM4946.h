...
#define	LM4946_MODE_MC						GENMASK(2, 0)	 // Output mode select
...
#define	LM4946_N3D_LEVEL					GENMASK(3, 2)	 // Enhancement level
...
#define	LM4946_MONO_VOL_VOL					GENMASK(4, 0)	 // Volume code from -54 dB (0x00) through 0 dB (0x13) to +18 dB (0x1F)
#define	LM4946_MONO_VOL_VOL_SHIFT			0

/* Left (LIN) volume */
#define	LM4946_LEFT_VOL						0xC0
#define	LM4946_LEFT_VOL_VOL					GENMASK(4, 0)	 // Volume code from -54 dB (0x00) through 0 dB (0x13) to +18 dB (0x1F)
#define	LM4946_LEFT_VOL_VOL_SHIFT			0

/* Right (RIN) volume */
#define	LM4946_RIGHT_VOL					0xE0
#define	LM4946_RIGHT_VOL_VOL				GENMASK(4, 0)	 // Volume code from -54 dB (0x00) through 0 dB (0x13) to +18 dB (0x1F)
