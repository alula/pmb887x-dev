...
#define	ILI9320_ENTRY_MODE_ID						GENMASK(5, 4)	 // Horizontal and vertical address directions
...
#define	ILI9320_RESIZE_CONTROL_RSZ					GENMASK(1, 0)	 // Image resizing factor
#define	ILI9320_RESIZE_CONTROL_RSZ_SHIFT			0
#define	ILI9320_RESIZE_CONTROL_RCH					GENMASK(5, 4)	 // Horizontal remainder pixel count
#define	ILI9320_RESIZE_CONTROL_RCH_SHIFT			4
#define	ILI9320_RESIZE_CONTROL_RCV					GENMASK(9, 8)	 // Vertical remainder pixel count
...
#define	ILI9320_DISPLAY_CONTROL_1_D					GENMASK(1, 0)	 // Display operating state
...
#define	ILI9320_DISPLAY_CONTROL_1_PTDE				GENMASK(13, 12)	 // Partial image enables
#define	ILI9320_DISPLAY_CONTROL_1_PTDE_SHIFT		12

/* Vertical front and back porch timing */
#define	ILI9320_DISPLAY_CONTROL_2					0x08
#define	ILI9320_DISPLAY_CONTROL_2_BP				GENMASK(3, 0)	 // Vertical back porch in lines
#define	ILI9320_DISPLAY_CONTROL_2_BP_SHIFT			0
#define	ILI9320_DISPLAY_CONTROL_2_FP				GENMASK(11, 8)	 // Vertical front porch in lines
...
#define	ILI9320_DISPLAY_CONTROL_3_ISC				GENMASK(3, 0)	 // Interval scan cycle
#define	ILI9320_DISPLAY_CONTROL_3_ISC_SHIFT			0
#define	ILI9320_DISPLAY_CONTROL_3_PTG				GENMASK(5, 4)	 // Non-display gate scan mode
#define	ILI9320_DISPLAY_CONTROL_3_PTG_SHIFT			4
#define	ILI9320_DISPLAY_CONTROL_3_PTS				GENMASK(10, 8)	 // Non-display source output level
#define	ILI9320_DISPLAY_CONTROL_3_PTS_SHIFT			8

/* Frame-marker output control */
#define	ILI9320_DISPLAY_CONTROL_4					0x0A
#define	ILI9320_DISPLAY_CONTROL_4_FMI				GENMASK(2, 0)	 // Frame-marker output interval
...
#define	ILI9320_RGB_INTERFACE_CONTROL_1_RIM			GENMASK(1, 0)	 // RGB interface width
#define	ILI9320_RGB_INTERFACE_CONTROL_1_RIM_SHIFT	0
#define	ILI9320_RGB_INTERFACE_CONTROL_1_DM			GENMASK(5, 4)	 // Display synchronization source
#define	ILI9320_RGB_INTERFACE_CONTROL_1_DM_SHIFT	4
#define	ILI9320_RGB_INTERFACE_CONTROL_1_RM			BIT(8)			 // GRAM access interface
#define	ILI9320_RGB_INTERFACE_CONTROL_1_ENC			GENMASK(15, 13)	 // RGB-interface GRAM write cycle
#define	ILI9320_RGB_INTERFACE_CONTROL_1_ENC_SHIFT	13

/* Frame-marker output position */
#define	ILI9320_FRAME_MARKER						0x0D
#define	ILI9320_FRAME_MARKER_FMP					GENMASK(8, 0)	 // Frame-marker output line
...
#define	ILI9320_POWER_CONTROL_1_AP					GENMASK(6, 4)	 // Operational-amplifier drive current
#define	ILI9320_POWER_CONTROL_1_AP_SHIFT			4
#define	ILI9320_POWER_CONTROL_1_APE					BIT(7)			 // Power supply enable
#define	ILI9320_POWER_CONTROL_1_BT					GENMASK(11, 8)	 // Step-up circuit factors
...
#define	ILI9320_POWER_CONTROL_2_VC					GENMASK(2, 0)	 // VCI reference voltage ratio
#define	ILI9320_POWER_CONTROL_2_VC_SHIFT			0
#define	ILI9320_POWER_CONTROL_2_DC0					GENMASK(6, 4)	 // Step-up circuit 1 frequency
#define	ILI9320_POWER_CONTROL_2_DC0_SHIFT			4
#define	ILI9320_POWER_CONTROL_2_DC1					GENMASK(10, 8)	 // Step-up circuit 2 frequency
#define	ILI9320_POWER_CONTROL_2_DC1_SHIFT			8

/* VGL, VREG1OUT, and VCOM reference control */
#define	ILI9320_POWER_CONTROL_3						0x12
#define	ILI9320_POWER_CONTROL_3_VRH					GENMASK(3, 0)	 // VREG1OUT amplification ratio
...
#define	ILI9320_FRAME_RATE_CONTROL_FR_SEL			GENMASK(5, 4)	 // Internal oscillator frame rate
